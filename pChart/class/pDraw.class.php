...
class pDraw {
    ...
    function drawPolygon($Points, $Format = "") {
        ...
        if ($Surrounding != NULL) { $BorderR = $R + $Surrounding;
        ...
        if (!$NoFill) {
            if ($this -> Shadow && $this -> ShadowX != 0 && $this -> ShadowY != 0) {
                $this -> Shadow = FALSE;
                for ($i = 0; $i <= count($Points) - 1; $i = $i + 2) { $Shadow[] = $Points[$i] + $this -> ShadowX;
            ...
            if (count($Points) >= 6) { ImageFilledPolygon($this -> Picture, $Points, count($Points) / 2, $FillColor);
            }
        }
    ...
    function drawRoundedRectangle($X1, $Y1, $X2, $Y2, $Radius, $Format = "") {
        ...
        if ($Radius <= 0) { $this -> drawRectangle($X1, $Y1, $X2, $Y2, $Color);
            return (0);
        }
    ...
    function drawRoundedFilledRectangle($X1, $Y1, $X2, $Y2, $Radius, $Format = "") {
        ...
        if ($Radius <= 0) { $this -> drawFilledRectangle($X1, $Y1, $X2, $Y2, $Color);
            return (0);
        }
        ...
        for ($i = 0; $i <= 90; $i = $i + $Step) {
            ...
            if (!isset($Positions[$Yp])) { $Positions[$Yp]["X1"] = $Xp1;
                $Positions[$Yp]["X2"] = $Xp2;
            } else { $Positions[$Yp]["X1"] = ($Positions[$Yp]["X1"] + $Xp1) / 2;
    ...
    function drawRoundedFilledRectangle_deprecated($X1, $Y1, $X2, $Y2, $Radius, $Format = "") {
        ...
        if ($this -> getFirstDecimal($X2) >= 5) { $XOffset2 = 1;
        } else { $XOffset2 = 0;
        }
        if ($this -> getFirstDecimal($X1) <= 5) { $XOffset1 = 1;
        } else { $XOffset1 = 0;
        }

        if (!$this -> Antialias) { $XOffset1 = 1;
            $XOffset2 = 1;
        }
        ...
        for ($i = 0; $i <= 90; $i = $i + $Step) {
            ...
            if ($this -> getFirstDecimal($Xp1) > 5) { $XOffset1 = 1;
            } else { $XOffset1 = 0;
            }
            if ($this -> getFirstDecimal($Xp2) > 5) { $XOffset2 = 1;
            } else { $XOffset2 = 0;
            }
            if ($this -> getFirstDecimal($Yp) > 5) { $YOffset = 1;
            } else { $YOffset = 0;
            }
            ...
            if ($this -> getFirstDecimal($Xp1) > 7) { $XOffset1 = 1;
            } else { $XOffset1 = 0;
            }
            if ($this -> getFirstDecimal($Xp2) > 7) { $XOffset2 = 1;
            } else { $XOffset2 = 0;
            }
            if ($this -> getFirstDecimal($Yp) > 5) { $YOffset = 1;
            } else { $YOffset = 0;
    ...
    function drawSpline($Coordinates, $Format = "") {
        ...
        for ($i = 1; $i <= count($Coordinates) - 1; $i++) {
            ...
            /* Last segment */
            if ($i == count($Coordinates) - 1) { $Xv2 = $X2;
                $Yv2 = $Y2;
            } else {
    ...
    function drawBezier($X1, $Y1, $X2, $Y2, $Xv1, $Yv1, $Xv2, $Yv2, $Format = "") {
        ...
        if (!$NoDraw) {
            ...
            foreach ($Q as $Key => $Point) {
                ...
                if ($ArrowS == NULL && $LastX != NULL && $LastY != NULL) { $ArrowS["X2"] = $LastX;
                    $ArrowS["Y2"] = $LastY;
                    $ArrowS["X1"] = $X;
                    $ArrowS["Y1"] = $Y;
                }
            ...
            if ($Threshold != NULL) {
                foreach ($Threshold as $Key => $Parameters) {
                    if ($Y <= $Parameters["MinX"] && $Y >= $Parameters["MaxX"]) {
                        if (isset($Parameters["R"])) { $RT = $Parameters["R"];
                        } else { $RT = 0;
                        }
                        if (isset($Parameters["G"])) { $GT = $Parameters["G"];
                        } else { $GT = 0;
                        }
                        if (isset($Parameters["B"])) { $BT = $Parameters["B"];
                        } else { $BT = 0;
                        }
                        if (isset($Parameters["Alpha"])) { $AlphaT = $Parameters["Alpha"];
                        } else { $AlphaT = 0;
                        }
    ...
    function drawText($X, $Y, $Text, $Format = "") {
        ...
        if ($BoxSurrounding != "") { $BoxBorderR = $BoxR - $BoxSurrounding;
        ...
        if ($DrawBox && ($Angle == 0 || $Angle == 90 || $Angle == 180 || $Angle == 270)) {
            ...
            if ($BoxRounded) { $this -> drawRoundedFilledRectangle($X1, $Y1, $X2, $Y2, $RoundedRadius, $Settings);
            } else { $this -> drawFilledRectangle($X1, $Y1, $X2, $Y2, $Settings);
            }
        }
    ...
    function drawGradientArea($X1, $Y1, $X2, $Y2, $Direction, $Format = "") {
        ...
        if ($Levels != NULL) { $EndR = $StartR + $Levels;
            $EndG = $StartG + $Levels;
            $EndB = $StartB + $Levels;
        }
        ...
        switch($Direction) {
            case DIRECTION_VERTICAL :
                ...
                if ($LastY2 < $EndY && isset($Color)) {
                    for ($i = $LastY2 + 1; $i <= $EndY; $i++) { $this -> drawLine($X1, $i, $X2, $i, $Color);
                    }
                }
                break;
    ...
    function drawFromPNG($X, $Y, $FileName) { $this -> drawFromPicture(1, $FileName, $X, $Y);
    }

    /* Load a GIF file and draw it over the chart */
    function drawFromGIF($X, $Y, $FileName) { $this -> drawFromPicture(2, $FileName, $X, $Y);
    }

    /* Load a JPEG file and draw it over the chart */
    function drawFromJPG($X, $Y, $FileName) { $this -> drawFromPicture(3, $FileName, $X, $Y);
    }
    ...
    function drawFromPicture($PicType, $FileName, $X, $Y) {
        if (file_exists($FileName)) {
            ...
            } elseif ($PicType == 2) { $Raster = imagecreatefromgif($FileName);
            } elseif ($PicType == 3) { $Raster = imagecreatefromjpeg($FileName);
            } else {
                return (0);
            }
    ...
    function drawProgress($X, $Y, $Percent, $Format = "") {
        ...
        if ($BoxSurrounding != NULL) { $BoxBorderR = $BoxBackR + $Surrounding;
            ...
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if (isset($Serie["Picture"])) {
                    ...
                    if ($Family == LEGEND_FAMILY_BOX) {
                        if ($BoxWidth != $IconAreaWidth) { $XOffset = floor(($IconAreaWidth - $BoxWidth) / 2);
                        } else { $XOffset = 0;
                        }
                        if ($BoxHeight != $IconAreaHeight) { $YOffset = floor(($IconAreaHeight - $BoxHeight) / 2);
                        } else { $YOffset = 0;
                        }
    ...
    function drawScale($Format = "") {
        ...
        $Data = $this -> DataSet -> getData();
        if (isset($Data["Abscissa"])) { $Abscissa = $Data["Abscissa"];
        } else { $Abscissa = NULL;
        }
        ...
        foreach ($Data["Axis"] as $AxisID => $AxisParameter) {
            ...
            if ($Pos == SCALE_POS_LEFTRIGHT && $AxisParameter["Identity"] == AXIS_Y) { $Height = $this -> GraphAreaY2 - $this -> GraphAreaY1 - $YMargin * 2;
            } elseif ($Pos == SCALE_POS_LEFTRIGHT && $AxisParameter["Identity"] == AXIS_X) { $Height = $this -> GraphAreaX2 - $this -> GraphAreaX1;
            } elseif ($Pos == SCALE_POS_TOPBOTTOM && $AxisParameter["Identity"] == AXIS_Y) { $Height = $this -> GraphAreaX2 - $this -> GraphAreaX1 - $YMargin * 2;
                ;
            } else { $Height = $this -> GraphAreaY2 - $this -> GraphAreaY1;
            }
            ...
            if ($Mode == SCALE_MODE_FLOATING || $Mode == SCALE_MODE_START0) {
                ...
                } else { echo "Manual scale boundaries not set.";
                    exit();
                }
                ...
                for ($ID = 0; $ID <= max($Series) - 1; $ID++) {
                    ...
                    foreach ($Series as $SerieID => $ValuesCount) {
                        if (isset($Data["Series"][$SerieID]["Data"][$ID]) && $Data["Series"][$SerieID]["Data"][$ID] != NULL) {
                            ...
                            if ($Value > 0) { $PointMax = $PointMax + $Value;
                            } else { $PointMin = $PointMin + $Value;
                            }
                        }
                    }
        ...
        if ($GotXAxis == FALSE) {
            ...
            if ($Pos == SCALE_POS_LEFTRIGHT) { $Data["Axis"][$AxisID]["Position"] = AXIS_POSITION_BOTTOM;
            } else { $Data["Axis"][$AxisID]["Position"] = AXIS_POSITION_LEFT;
            }
            if (isset($Data["AbscissaName"])) { $Data["Axis"][$AxisID]["Name"] = $Data["AbscissaName"];
            }
            if ($XMargin == AUTO) {
                if ($Pos == SCALE_POS_LEFTRIGHT) { $Height = $this -> GraphAreaX2 - $this -> GraphAreaX1;
                } else { $Height = $this -> GraphAreaY2 - $this -> GraphAreaY1;
                }
        ...
        if ($Pos != SCALE_POS_LEFTRIGHT) {
            if ($Data["AbsicssaPosition"] == AXIS_POSITION_BOTTOM) { $Data["AbsicssaPosition"] = AXIS_POSITION_LEFT;
            } else { $Data["AbsicssaPosition"] = AXIS_POSITION_RIGHT;
            }
        }
            ...
            if ($Parameters["Identity"] == AXIS_X) {
                if ($Pos == SCALE_POS_LEFTRIGHT) {
                    if ($Parameters["Position"] == AXIS_POSITION_BOTTOM) {
                        if ($LabelRotation == 0) { $LabelAlign = TEXT_ALIGN_TOPMIDDLE;
                            $YLabelOffset = 2;
                        }
                        if ($LabelRotation > 0 && $LabelRotation < 190) { $LabelAlign = TEXT_ALIGN_MIDDLERIGHT;
                            $YLabelOffset = 5;
                        }
                        if ($LabelRotation == 180) { $LabelAlign = TEXT_ALIGN_BOTTOMMIDDLE;
                            $YLabelOffset = 5;
                        }
                        if ($LabelRotation > 180 && $LabelRotation < 360) { $LabelAlign = TEXT_ALIGN_MIDDLELEFT;
                            $YLabelOffset = 2;
                        }

                        if (!$RemoveXAxis) {
                            if ($Floating) { $FloatingOffset = $YMargin;
                        ...
                        if ($Parameters["Rows"] == 0) { $Step = $Width;
                        } else { $Step = $Width / ($Parameters["Rows"]);
                        }
                        ...
                        for ($i = 0; $i <= $Parameters["Rows"]; $i++) {
                            ...
                            if ($Abscissa != NULL) {
                                if (isset($Data["Series"][$Abscissa]["Data"][$i])) { $Value = $this -> scaleFormat($Data["Series"][$Abscissa]["Data"][$i], $Data["XAxisDisplay"], $Data["XAxisFormat"], $Data["XAxisUnit"]);
                                } else { $Value = "";
                                }
                            } else {
                        ...
                        if ($LabelRotation == 0) { $LabelAlign = TEXT_ALIGN_BOTTOMMIDDLE;
                            $YLabelOffset = 2;
                        }
                        if ($LabelRotation > 0 && $LabelRotation < 190) { $LabelAlign = TEXT_ALIGN_MIDDLELEFT;
                            $YLabelOffset = 2;
                        }
                        if ($LabelRotation == 180) { $LabelAlign = TEXT_ALIGN_TOPMIDDLE;
                            $YLabelOffset = 5;
                        }
                        if ($LabelRotation > 180 && $LabelRotation < 360) { $LabelAlign = TEXT_ALIGN_MIDDLERIGHT;
                            $YLabelOffset = 5;
                        }
                    ...
                    if ($Parameters["Position"] == AXIS_POSITION_LEFT) {
                        if ($LabelRotation == 0) { $LabelAlign = TEXT_ALIGN_MIDDLERIGHT;
                            $XLabelOffset = -2;
                        }
                        if ($LabelRotation > 0 && $LabelRotation < 190) { $LabelAlign = TEXT_ALIGN_MIDDLERIGHT;
                            $XLabelOffset = -6;
                        }
                        if ($LabelRotation == 180) { $LabelAlign = TEXT_ALIGN_MIDDLELEFT;
                            $XLabelOffset = -2;
                        }
                        if ($LabelRotation > 180 && $LabelRotation < 360) { $LabelAlign = TEXT_ALIGN_MIDDLELEFT;
                            $XLabelOffset = -5;
                        ...
                        if ($Parameters["Rows"] == 0) { $Step = $Height;
                        } else { $Step = $Height / $Parameters["Rows"];
                        }
                        ...
                        if ($LabelRotation == 0) { $LabelAlign = TEXT_ALIGN_MIDDLELEFT;
                            $XLabelOffset = 2;
                        }
                        if ($LabelRotation > 0 && $LabelRotation < 190) { $LabelAlign = TEXT_ALIGN_MIDDLELEFT;
                            $XLabelOffset = 6;
                        }
                        if ($LabelRotation == 180) { $LabelAlign = TEXT_ALIGN_MIDDLERIGHT;
                            $XLabelOffset = 5;
                        }
                        if ($LabelRotation > 180 && $LabelRotation < 360) { $LabelAlign = TEXT_ALIGN_MIDDLERIGHT;
                            $XLabelOffset = 7;
            ...
            if ($Parameters["Identity"] == AXIS_Y) {
                if ($Pos == SCALE_POS_LEFTRIGHT) {
                    if ($Parameters["Position"] == AXIS_POSITION_LEFT) {
                        ...
                        if ($Floating) { $FloatingOffset = $XMargin;
                            $this -> drawLine($AxisPos["L"], $this -> GraphAreaY1 + $Parameters["Margin"], $AxisPos["L"], $this -> GraphAreaY2 - $Parameters["Margin"], array("R" => $AxisR, "G" => $AxisG, "B" => $AxisB, "Alpha" => $AxisAlpha));
                        } else { $FloatingOffset = 0;
                            $this -> drawLine($AxisPos["L"], $this -> GraphAreaY1, $AxisPos["L"], $this -> GraphAreaY2, array("R" => $AxisR, "G" => $AxisG, "B" => $AxisB, "Alpha" => $AxisAlpha));
                        }
                        ...
                        for ($i = 0; $i <= $Parameters["Rows"]; $i++) {
                            ...
                            if ($i % 2 == 1) { $BGColor = array("R" => $BackgroundR1, "G" => $BackgroundG1, "B" => $BackgroundB1, "Alpha" => $BackgroundAlpha1);
                            } else { $BGColor = array("R" => $BackgroundR2, "G" => $BackgroundG2, "B" => $BackgroundB2, "Alpha" => $BackgroundAlpha2);
                            }
    ...
    function computeScale($XMin, $XMax, $MaxDivs, $Factors, $AxisID = 0) {
        ...
        foreach ($GoodScaleFactors as $Key => $Factor) {
            if ($Results[$Factor]["Rows"] > $MaxRows) { $MaxRows = $Results[$Factor]["Rows"];
                $BestFactor = $Factor;
            }
        }
    ...
    function processScale($XMin, $XMax, $MaxDivs, $Factors, $AxisID) {
        ...
        if ($XMin != $XMax) {
            ...
            while (!$Found) {
                foreach ($Factors as $Key => $Factor) {
                    if (!$Found) {
                        if (!($this -> modulo($XMin, $Factor * $Scaled10Factor) == 0) || ($XMin != floor($XMin))) { $XMinRescaled = floor($XMin / ($Factor * $Scaled10Factor)) * $Factor * $Scaled10Factor;
                        } else { $XMinRescaled = $XMin;
                        }
                        if (!($this -> modulo($XMax, $Factor * $Scaled10Factor) == 0) || ($XMax != floor($XMax))) { $XMaxRescaled = floor($XMax / ($Factor * $Scaled10Factor)) * $Factor * $Scaled10Factor + ($Factor * $Scaled10Factor);
                        } else { $XMaxRescaled = $XMax;
                        }
                        $ScaleHeightRescaled = abs($XMaxRescaled - $XMinRescaled);

                        if (!$Found && floor($ScaleHeightRescaled / ($Factor * $Scaled10Factor)) <= $MaxDivs) { $Found = TRUE;
                            $Rescaled = TRUE;
    ...
    function modulo($Value1, $Value2) {
        ...
        $Factor = 10;
        while (floor($MinValue * $Factor) == 0) { $Factor = $Factor * 10;
        }
    ...
    function drawXThreshold($Value, $Format = "") {
        ...
        if (is_array($Value)) {
            foreach ($Value as $Key => $ID) { $this -> drawXThreshold($ID, $Format);
            }
            return (0);
        }
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            ...
            if ($XPos >= $this -> GraphAreaX1 + $AbscissaMargin && $XPos <= $this -> GraphAreaX2 - $AbscissaMargin) {
                ...
                if ($WriteCaption) {
                    if ($CaptionAlign == CAPTION_LEFT_TOP) { $Y = $YPos1 + $CaptionOffset;
                        $CaptionSettings["Align"] = TEXT_ALIGN_TOPMIDDLE;
                    } else { $Y = $YPos2 - $CaptionOffset;
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            ...
            if ($AreaName != NULL) {
                ...
                if ($NameAngle == ZONE_NAME_ANGLE_AUTO) {
                    ...
                    if (abs($XPos2 - $XPos1) > $TxtWidth) { $NameAngle = 0;
                    } else { $NameAngle = 90;
                    }
                }
                $this -> Shadow = $RestoreShadow;
    ...
    function drawThreshold($Value, $Format = "") {
        ...
        if (is_array($Value)) {
            foreach ($Value as $Key => $ID) { $this -> drawThreshold($ID, $Format);
            }
            return (0);
        }
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            ...
            if ($YPos >= $this -> GraphAreaY1 + $Data["Axis"][$AxisID]["Margin"] && $YPos <= $this -> GraphAreaY2 - $Data["Axis"][$AxisID]["Margin"]) {
                ...
                if ($WriteCaption) {
                    if ($CaptionAlign == CAPTION_LEFT_TOP) { $X = $X1 + $CaptionOffset;
                        $CaptionSettings["Align"] = TEXT_ALIGN_MIDDLELEFT;
                    } else { $X = $X2 - $CaptionOffset;
                        $CaptionSettings["Align"] = TEXT_ALIGN_MIDDLERIGHT;
                    }
        ...
        if ($Data["Orientation"] == SCALE_POS_TOPBOTTOM) {
            ...
            if ($XPos >= $this -> GraphAreaX1 + $Data["Axis"][$AxisID]["Margin"] && $XPos <= $this -> GraphAreaX2 - $Data["Axis"][$AxisID]["Margin"]) {
                ...
                if ($WriteCaption) {
                    if ($CaptionAlign == CAPTION_LEFT_TOP) { $Y = $Y1 + $CaptionOffset;
                        $CaptionSettings["Align"] = TEXT_ALIGN_TOPMIDDLE;
                    } else { $Y = $Y2 - $CaptionOffset;
                        $CaptionSettings["Align"] = TEXT_ALIGN_BOTTOMMIDDLE;
                    }
    ...
    function scaleComputeY($Values, $Option = "", $ReturnOnly0Height = FALSE) {
        ...
        if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
            ...
            if ($ReturnOnly0Height) {
                ...
                foreach ($Values as $Key => $Value) {
                    if ($Value == VOID) { $Result[] = VOID;
                    } else { $Result[] = $this -> GraphAreaY2 - $Data["Axis"][$AxisID]["Margin"] - ($Step * ($Value - $Data["Axis"][$AxisID]["ScaleMin"]));
                    }
                }
            }
        } else {
            ...
            if ($ReturnOnly0Height) {
                ...
                foreach ($Values as $Key => $Value) {
                    if ($Value == VOID) { $Result[] = VOID;
                    } else { $Result[] = $this -> GraphAreaX1 + $Data["Axis"][$AxisID]["Margin"] + ($Step * ($Value - $Data["Axis"][$AxisID]["ScaleMin"]));
                    }
                }
            }
        }
    ...
    function writeBounds($Type = BOUND_BOTH, $Format = NULL) {
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"] && !isset($ExcludedSeries[$SerieName])) {
                ...
                $Ticks = $Serie["Ticks"];
                if ($DisplayColor == DISPLAY_AUTO) { $DisplayR = $R;
                    $DisplayG = $G;
                    $DisplayB = $B;
                }
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    if ($Type == BOUND_MAX || $Type == BOUND_BOTH) {
                        if ($MaxLabelPos == BOUND_LABEL_POS_TOP || ($MaxLabelPos == BOUND_LABEL_POS_AUTO && $MaxValue >= 0)) { $YPos = $PosArray[$MaxPos] - $DisplayOffset + 2;
                            $Align = TEXT_ALIGN_BOTTOMMIDDLE;
                        }
                        if ($MaxLabelPos == BOUND_LABEL_POS_BOTTOM || ($MaxLabelPos == BOUND_LABEL_POS_AUTO && $MaxValue < 0)) { $YPos = $PosArray[$MaxPos] + $DisplayOffset + 2;
                    ...
                    if ($Type == BOUND_MIN || $Type == BOUND_BOTH) {
                        if ($MinLabelPos == BOUND_LABEL_POS_TOP || ($MinLabelPos == BOUND_LABEL_POS_AUTO && $MinValue >= 0)) { $YPos = $PosArray[$MinPos] - $DisplayOffset + 2;
                            $Align = TEXT_ALIGN_BOTTOMMIDDLE;
                        }
                        if ($MinLabelPos == BOUND_LABEL_POS_BOTTOM || ($MinLabelPos == BOUND_LABEL_POS_AUTO && $MinValue < 0)) { $YPos = $PosArray[$MinPos] + $DisplayOffset + 2;
                            $Align = TEXT_ALIGN_TOPMIDDLE;
                        }
    ...
    function drawPlotChart($Format = NULL) {
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                if (isset($Serie["Weight"])) { $SerieWeight = $Serie["Weight"] + 2;
                } else { $SerieWeight = 2;
                }
                ...
                if (isset($Serie["Picture"])) { $Picture = $Serie["Picture"];
                ...
                if (isset($Serie["Description"])) { $SerieDescription = $Serie["Description"];
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    if ($Picture != NULL) { $PicOffset = $PicHeight / 2;
                        $SerieWeight = 0;
                    }
                    $X = $this -> GraphAreaX1 + $XMargin;

                    if (!is_array($PosArray)) { $Value = $PosArray;
                        $PosArray = "";
                        $PosArray[0] = $Value;
                    }
                    foreach ($PosArray as $Key => $Y) {
                        ...
                        if ($Y != VOID) {
                            ...
                            if ($Picture != NULL) { $this -> drawFromPicture($PicType, $Picture, $X - $PicWidth / 2, $Y - $PicHeight / 2);
                            } else { $this -> drawShape($X, $Y, $Shape, $SerieWeight, $PlotBorder, $BorderSize, $R, $G, $B, $Alpha, $BorderR, $BorderG, $BorderB, $BorderAlpha);
                            }
                        }
                        $X = $X + $XStep;
                    }
                } else {
                    if ($XDivs == 0) { $YStep = ($this -> GraphAreaY2 - $this -> GraphAreaY1) / 4;
                    } else { $YStep = ($this -> GraphAreaY2 - $this -> GraphAreaY1 - $XMargin * 2) / $XDivs;
                    }
                    if ($Picture != NULL) { $PicOffset = $PicWidth / 2;
                        $SerieWeight = 0;
                    }
            ...
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        ...
                        if ($Y == VOID && $LastY != NULL) { $this -> drawSpline($WayPoints, array("Force" => $Force, "R" => $R, "G" => $G, "B" => $B, "Alpha" => $Alpha, "Ticks" => $Ticks, "Weight" => $Weight));
                            $WayPoints = "";
                        }

                        if ($Y != VOID && $LastY == NULL && $LastGoodY != NULL && !$BreakVoid) { $this -> drawLine($LastGoodX, $LastGoodY, $X, $Y, $BreakSettings);
                        }

                        if ($Y != VOID)
                            $WayPoints[] = array($X, $Y);

                        if ($Y != VOID) { $LastGoodY = $Y;
                            $LastGoodX = $X;
                        }
                        if ($Y == VOID) { $Y = NULL;
                        }
                    ...
                    foreach ($PosArray as $Key => $X) {
                        ...
                        if ($X == VOID && $LastX != NULL) { $this -> drawSpline($WayPoints, array("Force" => $Force, "R" => $R, "G" => $G, "B" => $B, "Alpha" => $Alpha, "Ticks" => $Ticks, "Weight" => $Weight));
                            $WayPoints = "";
                        }

                        if ($X != VOID && $LastX == NULL && $LastGoodX != NULL && !$BreakVoid) { $this -> drawLine($LastGoodX, $LastGoodY, $X, $Y, $BreakSettings);
                        }

                        if ($X != VOID)
                            $WayPoints[] = array($X, $Y);

                        if ($X != VOID) { $LastGoodX = $X;
                            $LastGoodY = $Y;
                        }
                        if ($X == VOID) { $X = NULL;
                        }
                            ...
                            if ($Area != "") {
                                foreach ($Area as $key => $Points) {
                                    ...
                                    foreach ($Points as $subKey => $Point) {
                                        if ($subKey == count($Points) - 1) { $Corners[] = $Point["X"] - 1;
                                        } else { $Corners[] = $Point["X"];
                                        }
                                        $Corners[] = $Point["Y"] + 1;
                                    }
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                            if ($Serie["Data"][$Key] > 0) { $Align = TEXT_ALIGN_BOTTOMMIDDLE;
                                $Offset = $DisplayOffset;
                            } else { $Align = TEXT_ALIGN_TOPMIDDLE;
                                $Offset = -$DisplayOffset;
                            }
                    ...
                    $LastGoodX = NULL;
                    foreach ($PosArray as $Key => $X) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) { $this -> drawText($X + $DisplayOffset + $Weight, $Y, $this -> scaleFormat($Serie["Data"][$Key], $Mode, $Format, $Unit), array("Angle" => 270, "R" => $DisplayR, "G" => $DisplayG, "B" => $DisplayB, "Align" => TEXT_ALIGN_BOTTOMMIDDLE));
                        }
                        ...
                        if ($X != VOID && $LastX == NULL && $LastGoodY != NULL && !$BreakVoid) { $this -> drawLine($LastGoodX, $LastGoodY, $X, $Y, $BreakSettings);
                            $LastGoodY = NULL;
                        }

                        if ($X != VOID) { $LastGoodY = $Y;
                            $LastGoodX = $X;
                        }
                        if ($X == VOID) { $X = NULL;
                        }
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                            if ($Y <= $LastY) { $Align = TEXT_ALIGN_BOTTOMMIDDLE;
                                $Offset = $DisplayOffset;
                            } else { $Align = TEXT_ALIGN_TOPMIDDLE;
                                $Offset = -$DisplayOffset;
                            }
                    ...
                    foreach ($PosArray as $Key => $X) {
                        if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                            if ($X >= $LastX) { $Align = TEXT_ALIGN_MIDDLELEFT;
                                $Offset = $DisplayOffset;
                            } else { $Align = TEXT_ALIGN_MIDDLERIGHT;
                                $Offset = -$DisplayOffset;
                            }
    ...
    function drawFilledStepChart($Format = NULL) {
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($ForceTransparency != NULL) { $Color["Alpha"] = $ForceTransparency;
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    if ($AroundZero) { $Areas[$AreaID][] = $YZero;
                    } else { $Areas[$AreaID][] = $this -> GraphAreaY2 - 1;
                    }
                    ...
                    foreach ($PosArray as $Key => $Y) {
                        ...
                        if ($Y == VOID && isset($Areas[$AreaID])) {
                            if ($LastX == NULL) { $Areas[$AreaID][] = $X;
                            } else { $Areas[$AreaID][] = $LastX;
                            }
                    ...
                    if ($this -> Shadow) {
                        ...
                        foreach ($Areas as $Key => $Points) {
                            ...
                            foreach ($Points as $Key2 => $Value) {
                                if ($Key2 % 2 == 0) { $ShadowArea[$Key][] = $Value + $this -> ShadowX;
                                } else { $ShadowArea[$Key][] = $Value + $this -> ShadowY;
                                }
                            }
                        }
                    ...
                    $AreaID = 0;
                    if ($AroundZero) { $Areas[$AreaID][] = $YZero;
                    } else { $Areas[$AreaID][] = $this -> GraphAreaX1 + 1;
                    }
                    ...
                    foreach ($PosArray as $Key => $X) {
                        ...
                        if ($X == VOID && isset($Areas[$AreaID])) {
                            ...
                            if ($LastY == NULL) { $Areas[$AreaID][] = $Y;
                            } else { $Areas[$AreaID][] = $LastY;
                            }
    ...
    function drawBarChart($Format = NULL) {
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($InnerSurrounding != NULL) { $InnerBorderR = $R + $InnerSurrounding;
                    $InnerBorderG = $G + $InnerSurrounding;
                    $InnerBorderB = $B + $InnerSurrounding;
                }
                if ($InnerBorderR == -1) { $InnerColor = NULL;
                } else { $InnerColor = array("R" => $InnerBorderR, "G" => $InnerBorderG, "B" => $InnerBorderB);
                }
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    if ($AroundZero) { $Y1 = $YZero;
                    } else { $Y1 = $this -> GraphAreaY2 - 1;
                    }
                    if ($XDivs == 0) { $XSize = ($this -> GraphAreaX2 - $this -> GraphAreaX1) / ($SeriesCount + $Interleave);
                    } else { $XSize = ($XStep / ($SeriesCount + $Interleave));
                    }
                    ...
                    foreach ($PosArray as $Key => $Y2) {
                        if ($Floating0Serie != NULL) {
                            if (isset($Data["Series"][$Floating0Serie]["Data"][$Key])) { $Value = $Data["Series"][$Floating0Serie]["Data"][$Key];
                            } else { $Value = 0;
                            }
                        ...
                        if ($OverrideColors != NULL) {
                            if (isset($OverrideColors[$ID])) { $Color = array("R" => $OverrideColors[$ID]["R"], "G" => $OverrideColors[$ID]["G"], "B" => $OverrideColors[$ID]["B"], "Alpha" => $OverrideColors[$ID]["Alpha"], "BorderR" => $OverrideColors[$ID]["BorderR"], "BorderG" => $OverrideColors[$ID]["BorderG"], "BorderB" => $OverrideColors[$ID]["BorderB"]);
                        ...
                        if ($Y2 != VOID) {
                            ...
                            if ($Serie["Data"][$Key] == 0) {
                                ...
                                $this -> DataSet -> Data["Series"][$SerieName]["ImageData"][] = array($X + $XOffset + $XSpace, $Y1, $X + $XOffset + $XSize - $XSpace, $Y2);
                    ...
                    if ($AroundZero) { $X1 = $YZero;
                    } else { $X1 = $this -> GraphAreaX1 + 1;
                    }
                    if ($XDivs == 0) { $YSize = ($this -> GraphAreaY2 - $this -> GraphAreaY1) / ($SeriesCount + $Interleave);
                    } else { $YSize = ($YStep / ($SeriesCount + $Interleave));
                    }
                    ...
                    foreach ($PosArray as $Key => $X2) {
                        ...
                        if ($X2 != VOID) {
                            ...
                            if (@$Serie["Data"][$Key] == 0) {
                                ...
                                $this -> DataSet -> Data["Series"][$SerieName]["ImageData"][$Key] = array($X1, $Y + $YOffset + $YSpace, $X2, $Y + $YOffset + $YSize - $YSpace);
                            ...
                            if ($DisplayValues && $Serie["Data"][$Key] != VOID) {
                                ...
                                if ($DisplayPos == LABEL_POS_INSIDE && abs($TxtWidth) < abs($BarWidth)) {
                                    ...
                                    if ($Serie["Data"][$Key] >= 0) { $Align = TEXT_ALIGN_MIDDLELEFT;
                                        $Offset = $DisplayOffset;
                                    } else { $Align = TEXT_ALIGN_MIDDLERIGHT;
                                        $Offset = -$DisplayOffset;
                                    }
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    foreach ($PosArray as $Key => $Height) {
                        if ($Height != VOID && $Serie["Data"][$Key] != 0) {
                            ...
                            if (($Rounded || $BorderR != -1) && ($Pos == "+" && $Y1 != $YZero)) { $YSpaceUp = 1;
                            } else { $YSpaceUp = 0;
                            }
                            if (($Rounded || $BorderR != -1) && ($Pos == "-" && $Y1 != $YZero)) { $YSpaceDown = 1;
                            } else { $YSpaceDown = 0;
                            }
                            ...
                            if ($Rounded)
                                ...
                                if ($InnerColor != NULL) { $RestoreShadow = $this -> Shadow;
                                    $this -> Shadow = FALSE;
                    ...
                    foreach ($PosArray as $Key => $Width) {
                        if ($Width != VOID && $Serie["Data"][$Key] != 0) {
                            ...
                            if (($Rounded || $BorderR != -1) && ($Pos == "+" && $X1 != $YZero)) { $XSpaceLeft = 2;
                            } else { $XSpaceLeft = 0;
                            }
                            if (($Rounded || $BorderR != -1) && ($Pos == "-" && $X1 != $YZero)) { $XSpaceRight = 2;
                            } else { $XSpaceRight = 0;
                            }
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                foreach ($Serie["Data"] as $Key => $Value) {
                    ...
                    if ($Sign == "+") { $Data["Series"][$SerieName]["Data"][$Key] = $Value + $OverallOffset[$Key][$Sign];
                    } else { $Data["Series"][$SerieName]["Data"][$Key] = $Value - $OverallOffset[$Key][$Sign];
                    }
        ...
        foreach ($SerieOrder as $Key => $SerieName) {
            ...
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    $this -> Shadow = $RestoreShadow;
                    if ($DrawLine) {
                        for ($i = 2; $i <= count($Plots) - 6; $i = $i + 2) { $this -> drawLine($Plots[$i], $Plots[$i + 1], $Plots[$i + 2], $Plots[$i + 3], $LineColor);
                        }
                    }
                    if ($DrawPlot) {
                        for ($i = 2; $i <= count($Plots) - 4; $i = $i + 2) {
                            if ($PlotBorder != 0) { $this -> drawFilledCircle($Plots[$i], $Plots[$i + 1], $PlotRadius + $PlotBorder, $PlotBorderColor);
                            }
                    ...
                    $Plots[] = $Y;
                    foreach ($PosArray as $Key => $Height) {
                        if ($Height != VOID) { $Plots[] = $YZero + $Height;
                            $Plots[] = $Y;
                        }
                        $Y = $Y + $YStep;
                    }
    ...
    function validatePalette($Colors, $Surrounding = NULL) {
        ...
        foreach ($Colors as $Key => $Values) {
            if (isset($Values["R"])) { $Result[$Key]["R"] = $Values["R"];
            } else { $Result[$Key]["R"] = rand(0, 255);
            }
            if (isset($Values["G"])) { $Result[$Key]["G"] = $Values["G"];
            } else { $Result[$Key]["G"] = rand(0, 255);
            }
            if (isset($Values["B"])) { $Result[$Key]["B"] = $Values["B"];
            } else { $Result[$Key]["B"] = rand(0, 255);
            }
            if (isset($Values["Alpha"])) { $Result[$Key]["Alpha"] = $Values["Alpha"];
            } else { $Result[$Key]["Alpha"] = 100;
            }
            ...
            if ($Surrounding != NULL) {
                ...
                if (isset($Values["BorderR"])) { $Result[$Key]["BorderR"] = $Values["BorderR"];
                } else { $Result[$Key]["BorderR"] = $Result[$Key]["R"];
                }
                if (isset($Values["BorderG"])) { $Result[$Key]["BorderG"] = $Values["BorderG"];
                } else { $Result[$Key]["BorderG"] = $Result[$Key]["G"];
                }
                if (isset($Values["BorderB"])) { $Result[$Key]["BorderB"] = $Values["BorderB"];
                } else { $Result[$Key]["BorderB"] = $Result[$Key]["B"];
                }
                if (isset($Values["BorderAlpha"])) { $Result[$Key]["BorderAlpha"] = $Values["BorderAlpha"];
                } else { $Result[$Key]["BorderAlpha"] = $Result[$Key]["Alpha"];
                }
            }
        }
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    $MaxSlope = 1;
                    foreach ($PosArray as $Key => $Y) {
                        if ($Y != VOID && $LastX != NULL) { $Slope = ($LastY - $Y);
                    ...
                    if ($XDivs == 0) { $XStep = ($this -> GraphAreaY2 - $this -> GraphAreaY1) / 4;
                    } else { $XStep = ($this -> GraphAreaY2 - $this -> GraphAreaY1 - $XMargin * 2) / $XDivs;
                    }
                    $Y = $this -> GraphAreaY1 + $XMargin;
                    ...
                    $MaxSlope = 1;
                    foreach ($PosArray as $Key => $X) {
                        if ($X != VOID && $LastX != NULL) { $Slope = ($X - $LastX);
                            if ($Slope > $MaxSlope) { $MaxSlope = $Slope;
                            }
                            if ($Slope < $MinSlope) { $MinSlope = $Slope;
                            }
    ...
    function drawBestFit($Format = "") {
        ...
        foreach ($Data["Series"] as $SerieName => $Serie) {
            if ($Serie["isDrawable"] == TRUE && $SerieName != $Data["Abscissa"]) {
                if ($OverrideR != VOID && $OverrideG != VOID && $OverrideB != VOID) { $R = $OverrideR;
                    $G = $OverrideG;
                    $B = $OverrideB;
                } else { $R = $Serie["Color"]["R"];
                    $G = $Serie["Color"]["G"];
                    $B = $Serie["Color"]["B"];
                }
                if ($OverrideTicks == NULL) { $Ticks = $Serie["Ticks"];
                } else { $Ticks = $OverrideTicks;
                }
                if ($OverrideAlpha == VOID) { $Alpha = $Serie["Color"]["Alpha"];
                } else { $Alpha = $OverrideAlpha;
                }
                ...
                if ($Data["Orientation"] == SCALE_POS_LEFTRIGHT) {
                    ...
                    if ($Y1 < $this -> GraphAreaY1) { $X1 = $X1 + ($this -> GraphAreaY1 - $Y1);
                        $Y1 = $this -> GraphAreaY1;
                    }
                    if ($Y1 > $this -> GraphAreaY2) { $X1 = $X1 + ($Y1 - $this -> GraphAreaY2);
                        $Y1 = $this -> GraphAreaY2;
                    }
                    if ($Y2 < $this -> GraphAreaY1) { $X2 = $X2 - ($this -> GraphAreaY1 - $Y2);
                        $Y2 = $this -> GraphAreaY1;
                    }
                    if ($Y2 > $this -> GraphAreaY2) { $X2 = $X2 - ($Y2 - $this -> GraphAreaY2);
                        $Y2 = $this -> GraphAreaY2;
                    }
                    ...
                    if ($X1 < $this -> GraphAreaX1) { $Y1 = $Y1 + ($this -> GraphAreaX1 - $X1);
                        $X1 = $this -> GraphAreaX1;
                    }
                    if ($X1 > $this -> GraphAreaX2) { $Y1 = $Y1 + ($X1 - $this -> GraphAreaX2);
                        $X1 = $this -> GraphAreaX2;
                    }
                    if ($X2 < $this -> GraphAreaX1) { $Y2 = $Y2 - ($this -> GraphAreaY1 - $X2);
                        $X2 = $this -> GraphAreaX1;
                    }
                    if ($X2 > $this -> GraphAreaX2) { $Y2 = $Y2 - ($X2 - $this -> GraphAreaX2);
                        $X2 = $this -> GraphAreaX2;
                    }
    ...
    function writeLabel($SeriesName, $Indexes, $Format = "") {
        ...
        if (!is_array($Indexes)) { $Index = $Indexes;
            $Indexes = "";
            $Indexes[] = $Index;
        }
        if (!is_array($SeriesName)) { $SerieName = $SeriesName;
            $SeriesName = "";
            $SeriesName[] = $SerieName;
        }
        if ($ForceLabels != NULL && !is_array($ForceLabels)) { $ForceLabel = $ForceLabels;
            $ForceLabels = "";
    ...
    function drawLabelBox($X, $Y, $Title, $Captions, $Format = "") {
        ...
        if (!$DrawSerieColor) { $SerieBoxSize = 0;
            $SerieBoxSpacing = 0;
        }
    ...
    function drawPolygonChart($Points, $Format = "") {
        ...
        $Segments = "";
        for ($i = 2; $i <= count($Points) - 2; $i = $i + 2) { $Segments[] = array("X1" => $Points[$i - 2], "Y1" => $Points[$i - 1], "X2" => $Points[$i], "Y2" => $Points[$i + 1]);
        }
            ...
            for ($Y = $MinY; $Y <= $MaxY; $Y = $Y + $YStep) {
                ...
                foreach ($Segments as $Key => $Coords) {
                    ...
                    if (min($Y1, $Y2) <= $Y && max($Y1, $Y2) >= $Y) {
                        if ($Y1 == $Y2) { $X = $X1;
                        } else { $X = $X1 + (($Y - $Y1) * $X2 - ($Y - $Y1) * $X1) / ($Y2 - $Y1);
                        }
                        ...
                        if (!is_array($Intersections)) { $Intersections[] = $X;
                        } elseif (!in_array($X, $Intersections)) { $Intersections[] = $X;
                ...
                if ($RestoreLast != "-") { $Intersections[] = $RestoreLast;
                    echo "@" . $Y . "\r\n";
                }
                ...
                if (is_array($Intersections)) {
                    ...
                    for ($i = 0; $i <= count($Intersections) - 1; $i = $i + 2) {
                        if (isset($Intersections[$i + 1])) {
                            if ($Intersections[$i] != $Intersections[$i + 1]) { $Result[] = $Intersections[$i];
                        ...
                        foreach ($Intersections as $Key => $X) {
                            ...
                            elseif ($LastX != OUT_OF_SIGHT) {
                                ...
                                if ($Threshold != NULL) {
                                    foreach ($Threshold as $Key => $Parameters) {
                                        if ($Y <= $Parameters["MinX"] && $Y >= $Parameters["MaxX"]) {
                                            if (isset($Parameters["R"])) { $R = $Parameters["R"];
                                            } else { $R = 0;
                                            }
                                            if (isset($Parameters["G"])) { $G = $Parameters["G"];
                                            } else { $G = 0;
                                            }
                                            if (isset($Parameters["B"])) { $B = $Parameters["B"];
                                            } else { $B = 0;
                                            }
                                            if (isset($Parameters["Alpha"])) { $Alpha = $Parameters["Alpha"];
                                            } else { $Alpha = 100;
                                            }
                                            $Color = $this -> allocateColor($this -> Picture, $R, $G, $B, $Alpha);
                                        }
