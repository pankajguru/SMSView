...
class satisfactionPriorityScatterBestuur {
...
//        $satisfactionPriorityScatter_docx->importStyles('./templates/otp-muis.docx', 'merge', array('Normal','ListParagraphPHPDOCX'));
        ...
        $satisfactionPriorityScatter_docx->addText('Het bestuur scoort op de volgende rubrieken \'Meer belangrijk/Meer tevreden\':',array(
                'sz' => 10,
                'font' => 'Century Gothic'
        ));
        ...
        $satisfactionPriorityScatter_docx->addText('Het bestuur scoort op de volgende rubrieken \'Meer belangrijk/Minder tevreden\':',array(
                'sz' => 10,
                'font' => 'Century Gothic'
        ));
