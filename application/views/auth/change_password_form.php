...
<table>
	<tr>
		<td><?php echo form_label('Oud wachtwoord', $old_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label('Nieuw wachtwoord', $new_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label('Bevestig nieuw wachtwoord', $confirm_new_password['id']); ?></td>
...
<?php echo form_submit('change', 'Verander wachtwoord'); ?>
<?php echo form_close(); ?>