...
/**
 * Create a DOCX file. Line Chart example
 *
 * @category   Phpdocx
 * @package    examples
 * @subpackage easy
...
$html = '
<span>Source:  <a href="http://statcounter.com/" class="link_destacado">STATCOUNTER</a></span>';

$docx->addHTML($html);

$docx->createDocx('example_line_chart');
